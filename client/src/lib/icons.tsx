...
const base = (
  ...
  { size = 16, style: userStyle, ...rest }: IconProps = {}
): JSX.Element => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
...
export const IconTv = (p: IconProps): JSX.Element =>
  base(
...
export const IconBackward = (p: IconProps): JSX.Element =>
  base(
...
export const IconArrowsOut = (p: IconProps): JSX.Element =>
  base(
...
export const IconPlus = (p: IconProps): JSX.Element => base(<path d="M12 4.5v15m7.5-7.5h-15" />, p);
...
export const IconDocument = (p: IconProps): JSX.Element =>
  base(
...
export const IconArrowLeft = (p: IconProps): JSX.Element =>
  base(<path d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />, p);
...
export const IconCog = (p: IconProps): JSX.Element =>
  base(
...
export const IconAdjustments = (p: IconProps): JSX.Element =>
  base(
    <path d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />,
    p
  );

export const IconSquares = (p: IconProps): JSX.Element =>
  base(
...
export const IconQuestion = (p: IconProps): JSX.Element =>
  base(
...
export const IconExclamation = (p: IconProps): JSX.Element =>
  base(<path d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z" />, p);

export const IconSignOut = (p: IconProps): JSX.Element =>
  base(
...
export const IconBug = (p: IconProps): JSX.Element =>
  base(
    <path d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />,
    p
  );
