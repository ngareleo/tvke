...
export function PlayerPage() {
  ...
  return (
    <Box maxW="1600px" mx="auto">
      <Suspense fallback={<Box display="flex" justifyContent="center" pt={20}><Spinner size="xl" /></Box>}>
        <PlayerContent videoId={atob(videoId).startsWith("Video:") ? videoId : btoa(`Video:${videoId}`)} />
      </Suspense>
    </Box>
  );
}
